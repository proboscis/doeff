...
> - New `SegmentKind` variant added: `MaskBoundary` (R17-C). `FinallyBoundary` removed in R18-D.
> - `finally_cleanups` removed from Segment (R18-A). Use Python `try/finally` for cleanup.
>
