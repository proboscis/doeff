;; この package は業務を知らない(2026-09-25 — doeff-agents から切り出した時の決まり・doeff-cluster の同名の検と同じ形)。業務の系の語が source・検・配備の材料・文書に
...
(deftest test-the-scan-covers-the-package
  ...
  (for [want ["src/doeff_claude_code/effects.hy" "src/doeff_claude_code/handler.hy" "src/doeff_claude_code/fake.hy"
              "tests/test_scenarios.hy" "tests/stub_cli/claude.hy" "tests/conftest.py" "README.md" "pyproject.toml"]]
