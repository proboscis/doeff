  ...
  :laws
    [(law conversation-outlives-incarnation
     ...
     (law resume-rejects-are-machine-readable
       :statement "resume_admission_reject => stable_error_code_on_wire(one_live_incarnation | identity_unknown | transcript_not_discoverable | kind_not_supported); consumers_never_match_message_substrings"
       :counterexamples
