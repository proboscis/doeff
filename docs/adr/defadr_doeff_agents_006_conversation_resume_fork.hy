  ...
  :laws
    [(law conversation-outlives-incarnation
     ...
     (law auto-memory-home-is-keyed-by-the-conversation
       :statement "conversation_scoped_durable_state_location => derived_from_conversation_id_only(memory_root + conversation_id); never_from_custody_account_or_credential_home_or_working_directory; stamped_on_every_waking_arm(launch | resume | rehydrate)"
       :counterexamples
