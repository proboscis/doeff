...
class KleisliProgram(ABC, Generic[P, T]):
    ...
    _auto_unwrap_strategy: ClassVar[Any | None] = None
    _metadata_source: ClassVar[Any | None] = None
    _is_do_decorated: ClassVar[bool] = False
    _doeff_generator_factory: ClassVar[Any | None] = None
    ...
    def __call__(self, *args: P.args, **kwargs: P.kwargs) -> Program[T]:
        from doeff_vm import DoCtrlBase, Expand, Perform, Pure
        ...
        return Expand(Pure(self.func), positional_args, keyword_args, metadata)
