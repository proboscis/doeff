...
from doeff.types import Effect, EffectBase, EffectCreationContext, EffectGenerator
...
async def test_intercept_with_effect_to_program_no_recursion():
    ...
    result = await interpreter.run(intercepted_program, context)
...
async def test_intercept_with_nested_intercept_no_recursion():
    ...
    result = await interpreter.run(program_with_both, context)
